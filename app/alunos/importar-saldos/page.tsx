            ...
            <div className='card border-info'>
              ...
              <div className='card-body'>
                ...
                <ul>
                  ...
                  <li>Aceita valores com vírgula ou ponto como separador decimal</li>
                  <li>
                    Exemplo: <code>123456;100,50</code> ou <code>789012;250.00</code>
                  </li>
                </ul>
                <h6 className='mt-3'>Comportamento da importação:</h6>
                <ul>
                  <li>
                    Se o aluno já possui conta ativa, o saldo será <strong>atualizado</strong>
                  </li>
                  <li>
                    Se o aluno não possui conta, uma nova será <strong>criada</strong>
                  </li>
                  <li>Cada importação gera uma movimentação de ajuste no histórico</li>
                  <li>Erros em linhas específicas não interrompem o processamento</li>
                  <li>Um relatório detalhado será exibido ao final</li>
                </ul>
                <button className='btn btn-outline-info btn-sm mt-2' onClick={downloadTemplate}>
                  ...
                  <div className='row mb-4'>
                    ...
                    <div className='col-md-3 col-sm-6 mb-3'>
                      <div className='card bg-info text-white'>
                        <div className='card-body text-center'>
                          <h3 className='mb-0'>{resultado.contasAtualizadas}</h3>
                  ...
                  {resultado.alunosAfetados.length > 0 && (
                    <div>
                      <h6 className='text-success'>
                        <i className='bi bi-check-circle me-2'></i>
                        Alunos Processados com Sucesso ({resultado.alunosAfetados.length})
                      </h6>
                      <div
                        className='table-responsive'
                        ...
                        <table className='table table-sm table-hover'>
                          ...
                          <tbody>
                            {resultado.alunosAfetados.map((aluno, index) => {
                              const diferenca = aluno.saldoNovo - aluno.saldoAnterior;
                              return (
                                <tr key={index}>
                                  <td>{aluno.ra}</td>
                                  <td>{aluno.nome}</td>
                                  <td className='text-end'>{formatarMoeda(aluno.saldoAnterior)}</td>
                                  <td className='text-end'>{formatarMoeda(aluno.saldoNovo)}</td>
                                  <td
                                    className={`text-end ${
