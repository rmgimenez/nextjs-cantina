          ...
          <div className='col-md-3 mb-4'>
            <div className='card border-0 shadow-sm card-dashboard'>
              <div className='card-body text-center'>
                ...
                <small className='text-muted'>{vendasHoje.quantidade} vendas realizadas</small>
              </div>
            </div>
          </div>
                      ...
                      <tbody>
                        {ultimasVendas.map((v) => (
                          <tr key={v.id}>
                            ...
                            <td>
                              <span className='badge bg-secondary'>{v.tipo_cliente}</span>
                            </td>
                            <td>{new Date(v.dt_venda).toLocaleString('pt-BR')}</td>
                      ...
                      <tbody>
                        {estoqueBaixo.map((e) => (
                          <tr key={e.id}>
                            ...
                            <td className='text-end'>{Number(e.quantidade_atual).toFixed(3)}</td>
                            <td className='text-end'>{Number(e.quantidade_minima).toFixed(3)}</td>
                            <td>
                              <span
                                className={`badge ${
