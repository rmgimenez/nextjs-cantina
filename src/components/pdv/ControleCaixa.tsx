...
export default function ControleCaixa({
  ...
  const [mostrarModalMov, setMostrarModalMov] = useState<
    null | "sangria" | "reforco"
  >(null);
  ...
  const handleMovimentacao = async () => {
    ...
    if (
      mostrarModalMov === "sangria" &&
      status.caixa &&
      valor > status.caixa.valorCalculado
    ) {
          ...
          {!status.caixaAberto ? (
            <div className="">
              <div className="alert alert-danger text-center py-3">
                <FiLock className="me-2" /> Caixa fechado – abra para realizar
                vendas
              </div>
                ...
                <div className="col-12">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      ...
                      value={valorInicial}
                      onChange={(e) =>
                        setValorInicial(formatarMoeda(e.target.value))
                      }
                  ...
                  <div className="col-6">
                    ...
                    <div className="fw-semibold">
                      {status.caixa?.dataAbertura
                        ? new Date(status.caixa.dataAbertura).toLocaleString(
                            "pt-BR"
                          )
                        : "-"}
                    </div>
              ...
              <div className="bg-light rounded p-3 mb-3">
                ...
                <ul className="list-unstyled mb-0 small">
                  <li className="d-flex justify-content-between">
                    ...
                    <span>
                      R$ {status.caixa?.valorInicial.toFixed(2) || "0,00"}
                    </span>
                  </li>
                  <li className="d-flex justify-content-between">
              ...
              <div className="modal-body">
                ...
                <div className="input-group mb-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setValorFechamento(formatarMoeda(e.target.value))
                    }
                    className="form-control"
                    placeholder="0,00"
                  />
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="mb-3">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      ...
                      value={valorMov}
                      onChange={(e) =>
                        setValorMov(formatarMoeda(e.target.value))
                      }
                      placeholder="0,00"
                      disabled={processando}
                    />
                  ...
                  {mostrarModalMov === "sangria" && status.caixa && (
                    <small className="text-muted">
                      Disponível em caixa: R${" "}
                      {status.caixa.valorCalculado.toFixed(2)}
                    </small>
                  )}
                </div>
                <div className="mb-3">
                ...
                <div className="alert alert-info py-2 small">
                  Justificativa é obrigatória e ficará registrada no histórico
                  do caixa.
                </div>
              </div>
              <div className="modal-footer">
